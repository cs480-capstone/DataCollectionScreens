...
@Component({
 ...
 export class Graphs {
  ...
  showPollenCones: boolean = true;
  showUnfoldingLeaves: boolean = true;
  showFullSizedLeaves: boolean = true;
  showColoredLeaves: boolean = true;
  showOpenedFlowers: boolean = true;
  showRipeFruits: boolean = true;

  showNumberOfBreakingPollenCones: boolean = true;
