...
@Component({
 ...
 export class Graphs {
  ...
  constructor(public navCtrl: NavController, public popoverCtrl: PopoverController, navParams: NavParams, private passer : EntryPasser, private alert : AlertController, private UserFactory:UserFactory) {
    console.log("made it here")
      ...
      points = this.awardpoints(navParams.get("params"));
  ...
  collectData()
  {
    ...
    this.presentPoints();
    //these check if the data is to be recorded in the database
  ...
  presentPoints()
  {
    let alert = this.alert.create(
      {
        title : "Data sent!",
        subTitle : "You earned"+points+"drops",
        buttons : ["Continue"]
      }
    );
    alert.present();
